function [Q_C, delta_Q, Q_proportion_plot, schedule_info, L_bank_status_info] = L_bank_schedule(T_sample, Q_L, Cap, ...
                                                                                                L_bank_proportion, ...
                                                                                                Max_switch_times, Mode)
...
%                   Patent 120222404A, June 27, 2025.
    ...
    Q_L_Cal = (Q_L < 0).*Q_L;
    [k_C, Q_C, Q_proportion_plot] = initial_L_bank_schedule(Q_L_Cal, Cap, L_bank_proportion, Mode);
    [schedule_info, L_bank_status_info] = schedule_and_L_bank_status_info(T_sample, Q_L_Cal, ...
                                                              L_bank_proportion, k_C, Q_C, Mode);
    [k_C, Q_C] = curtailment_of_L_bank_overswitches(T_sample, Q_L_Cal, L_bank_proportion, k_C, Q_C, ...
